package com.hakagamesstudio.begreen.pojos.product_model;
...
public class ProductDetails implements Parcelable, Serializable {
    ...
    @SerializedName("comentProduct")
    @Expose
    private String comentProduct = "";
    ...
    public String getComentProduct() {
        return comentProduct;
    }

    public void setComentProduct(String comentProduct) {
        this.comentProduct = comentProduct;
    }
}
